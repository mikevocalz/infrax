      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl space-y-10">
          <div className="space-y-4 animate-in slide-in-from-left duration-700">
            ...
            <h1
              className="text-white font-black uppercase tracking-tighter leading-[0.9]"
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-6 animate-in slide-in-from-bottom duration-1000 delay-500">
            <Link
              href="/contact"
              className="px-12 py-6 bg-orange-accent text-white font-black uppercase tracking-widest hover:bg-white hover:text-navy transition-all shadow-2xl shadow-orange-500/20 text-center"
            >
              Request Audit
            </Link>
            <Link
