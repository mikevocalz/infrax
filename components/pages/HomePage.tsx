...
import { ChevronRight, ArrowRight, Zap, Shield, Target, Users, BarChart3, Globe } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl space-y-8 md:space-y-12">
            <div className="space-y-4 animate-in slide-in-from-left duration-700">
              ...
              <h1 className="text-white font-black uppercase tracking-tighter leading-[0.95] md:leading-[0.9]" style={{ fontSize: 'clamp(2.5rem, 8vw, 6rem)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 pt-4 animate-in slide-in-from-bottom duration-1000 delay-500">
              <button 
                ...
                className="px-8 py-5 md:px-12 md:py-6 bg-orange-accent text-white font-black uppercase tracking-widest hover:bg-white hover:text-navy transition-all shadow-2xl shadow-orange-500/20 text-sm md:text-base"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-start">
            <div className="space-y-10">
              ...
              <h2 className="text-4xl md:text-7xl font-black text-navy uppercase tracking-tighter leading-none">
                Why Infrastructure <br /><span className="text-orange-accent">Projects Stall.</span>
              </h2>
              <p className="text-xl text-slate-500 font-light leading-relaxed">
                Most infrastructure failures occur long before construction begins. InfraX eliminates assumptions. Every deployment is validated against deliverable megawatts — not theoretical availability.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 gap-px bg-slate-200 border border-slate-200">
              {[
                ...
                <div key={i} className="bg-white p-8 space-y-4 group hover:bg-slate-50 transition-colors">
                  <div className="w-8 h-8 bg-navy text-white flex items-center justify-center text-xs font-bold">0{i+1}</div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              <div className="bg-white/5 p-4 rounded-t-xl border-x border-t border-white/10 flex items-center gap-2">
                ...
                <div className="ml-4 text-[10px] font-mono text-white/40 uppercase tracking-widest">InfraAlign™ // Modeling Engine</div>
              </div>
              <div className="border border-white/10 shadow-2xl overflow-hidden bg-navy/50 aspect-video relative group flex items-center justify-center">
                <div className="absolute inset-0 opacity-20">
                  <img src="https://images.unsplash.com/photo-1551288049-bbbda536339a?q=80&w=2000" className="w-full h-full object-cover" />
                </div>
                <div className="relative z-10 text-center space-y-6 p-12">
                  ...
                  <div className="text-[10px] font-bold uppercase tracking-[0.4em] text-white/40">Feasibility Score // Region: NO_VA_01</div>
            ...
            <div className="space-y-10">
              ...
              <p className="text-xl text-white/60 font-light leading-relaxed">
                InfraAlign™ is the modeling engine behind every InfraX engagement. It ingests deployment requirements, simulates real-world constraints, and produces feasibility-ranked deployment scenarios — before capital is committed.
              </p>
              ...
              <button 
                onClick={() => onNavigate('platform')}
                className="px-12 py-6 bg-white text-navy font-black uppercase tracking-widest hover:bg-orange-accent hover:text-white transition-all"
              >
                Explore the Engine
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              { 
                ...
                desc: "Real-world modeling of power, cooling, and interconnection feasibility." 
              },
              { 
                title: "Execution", 
                icon: <Target size={32} />, 
                desc: "Neutral sourcing and operator alignment driven by validated outputs." 
              },
              { 
                title: "Discipline", 
                icon: <Shield size={32} />, 
                desc: "Governance frameworks tied directly to modeled risk exposure." 
              }
            ].map((item, i) => (
              <div key={i} className="space-y-8 p-12 bg-slate-50 border border-slate-200 hover:border-orange-accent transition-all group">
                <div className="w-16 h-16 bg-navy text-white flex items-center justify-center group-hover:bg-orange-accent transition-colors">
                  {item.icon}
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="aspect-square bg-navy overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1558494949-ef010cbdcc51?q=80&w=1000" className="w-full h-full object-cover opacity-40 grayscale" />
                </div>
              ...
              <div className="space-y-4 pt-12">
                ...
                <div className="aspect-square bg-navy overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1000" className="w-full h-full object-cover opacity-40 grayscale" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 md:py-32 lg:py-48 bg-navy text-white relative overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 relative z-10 space-y-8 md:space-y-12">
          <h2 className="text-4xl md:text-7xl lg:text-9xl font-black uppercase tracking-tighter leading-none">
            Model First. <br /><span className="text-orange-accent">Build Second.</span>
          </h2>
          <button 
            onClick={() => onNavigate('contact')}
            className="px-10 py-6 md:px-16 md:py-8 bg-orange-accent text-white font-black uppercase tracking-widest hover:bg-white hover:text-navy transition-all text-base md:text-xl shadow-2xl shadow-orange-500/20"
          >
            Request Infrastructure Audit
          </button>
        </div>
