  ...
  const industries = [
    {
      ...
      description: "Securing patient data and medical infrastructure with HIPAA-compliant SOC services and continuous threat monitoring.",
    ...
    },
    {
      ...
      description: "Military-grade defense for financial transactions and sensitive institutional data against sophisticated cyber adversaries.",
    ...
    },
    {
      ...
      description: "Protecting consumer trust and payment infrastructure during peak traffic and high-volume transaction periods.",
      metrics: ["PCI-DSS Alignment", "DDOS Mitigation", "Supply Chain Security"]
    },
    {
      title: "Public Sector",
      icon: <Building className="w-12 h-12 text-[#002b5c]" />,
      description: "Sovereign cybersecurity for government agencies, ensuring the integrity of public services and citizen data.",
      ...
      <div className="container mx-auto px-6 space-y-32 mb-32">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-end max-w-6xl mx-auto">
          <div className="space-y-6">
            ...
            <h1 className="text-5xl md:text-8xl font-black text-[#002b5c] uppercase tracking-tighter leading-[0.85]">
              INDUSTRY <br /><span className="text-[#f37021]">SOLUTIONS.</span>
            </h1>
          </div>
          <p className="text-xl md:text-2xl text-[#64748b] font-light leading-relaxed">
            Every industry faces unique threats. SecureX provides specialized security frameworks designed for the specific regulatory and technical challenges of your sector.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#002b5c]/10 border border-[#002b5c]/10">
          {industries.map((industry) => (
            <div key={industry.title} className="bg-white p-12 lg:p-16 hover:bg-[#f8fafc] transition-all group border-b md:border-b-0 border-[#002b5c]/5">
              <div className="mb-10">{industry.icon}</div>
              <h3 className="text-3xl font-black text-[#002b5c] uppercase tracking-tighter mb-6">{industry.title}</h3>
              <p className="text-[#64748b] font-light leading-relaxed mb-10 text-lg">{industry.description}</p>
              
              <div className="space-y-3 mb-12">
                {industry.metrics.map(m => (
                  <div key={m} className="flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest text-[#002b5c]">
        ...
        <section className="bg-[#002b5c] text-white p-12 lg:p-24 relative overflow-hidden industrial-grid-dark">
          <div className="max-w-4xl relative z-10 space-y-8">
            ...
            <h2 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter leading-none">The Zero-Trust <br />Foundation.</h2>
            <p className="text-xl text-white/60 font-light leading-relaxed">Regardless of industry, we implement a comprehensive Zero-Trust framework. We never trust, always verify, ensuring that your perimeter is not your only line of defense.</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10">
              {['Identity', 'Endpoints', 'Data', 'Apps'].map(item => (
                <div key={item}>
                  ...
                  <div className="text-[10px] text-[#f37021] font-bold uppercase mt-2">Verified</div>
                </div>
              ))}
            </div>
          </div>
